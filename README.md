...
To build a similar environment with Jupyter Notebook, please reference [requirements_jupyter-notebook.txt](https://github.com/j-salguero/CSCE676-DataMiningProject/blob/main/requirements_jupyter-notebook.txt)

To build a similar environment with Google Colab, please reference [requirements.txt](https://github.com/j-salguero/CSCE676-DataMiningProject/blob/main/requirements.txt)
